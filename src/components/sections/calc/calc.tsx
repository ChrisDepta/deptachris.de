  ...
  return (
    <div className="py-48">
      <div className="bg-white/[.60] p-6 rounded-3xl text-current flex text-4xl font-bold flex-col mb-36 ">
        <div className="h-36 flex justify-end items-end font-normal text-6xl text-primary/70 border-b bg-gradient-to-b from-transparent to-white/20 p-4 pb-6 rounded-2xl my-6">
          {result}
        </div>
        <div>
        ...
        <div className="flex ">
          <button className="grow" onClick={handleResetClick}>
            C
          </button>
          <button className="grow" onClick={handleEqualClick}>
            =
          </button>
        </div>
      </div>
